...
미국 상장주식을 대상으로 기업 데이터를 수집하고, 여러 투자 전문가의 관점으로 정량 평가한 뒤, 텔레그램 봇을 통해 요약 리포트를 제공하는 개인용 주식 평가 프로그램을 만든다.
...
목적:
미국 상장기업을 여러 투자 전문가의 관점으로 자동 평가하는 텔레그램 기반 개인 투자 분석 봇

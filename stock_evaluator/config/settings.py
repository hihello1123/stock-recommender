...
LOCAL_LLM_TIMEOUT_SECONDS = int(os.environ.get("LOCAL_LLM_TIMEOUT_SECONDS", "60"))
DAILY_NEWS_RSS_TIMEOUT_SECONDS = int(os.environ.get("DAILY_NEWS_RSS_TIMEOUT_SECONDS", "10"))
DAILY_NEWS_LLM_TIMEOUT_SECONDS = int(os.environ.get("DAILY_NEWS_LLM_TIMEOUT_SECONDS", "20"))
